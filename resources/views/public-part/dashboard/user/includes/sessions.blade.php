<div class="program__timeline program__timeline_{{ $program->id }}">
    <div class="program__timeline__sessions_mobile_sticky sticky">
        <div class="program__timeline-section dark dashboard_sessions">
                ...
                <div class="program__timeline-top">
                    ...
                    <div class="program__timeline-top-right">
                        @foreach($program->uniqueDateSessions() as $dates)
                            <a href="{{ route('dashboard.my-schedule-by-date', ['date' => $dates->date]) }}">
        ...
        <div class="program__timeline-section sticky dashboard_sessions_small">
            <div class="program__timeline-container">
