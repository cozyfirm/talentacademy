    ...
    <div class="hero-section">
        <div class="hero-section__container">
            ...
            <div class="hero-section__arrows">
                <img src="{{ asset('files/images/public-part/hnta_2026_home.png') }}" alt="Arrow" class="hero-section__arrow hero-section__arrow_d">
                <img src="{{ asset('files/images/public-part/hnta_2026_home.png') }}" alt="Arrow" class="hero-section__arrow hero-section__arrow_m">
