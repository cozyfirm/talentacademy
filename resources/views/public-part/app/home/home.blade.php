    ...
    <div class="hero-section">
        <div class="hero-section__container">
            ...
            <div class="hero-section__arrows">
                <img src="{{ asset('files/images/public-part/hnta_2026_home.svg') }}" alt="Arrow" class="hero-section__arrow hero-section__arrow_d">
                <img src="{{ asset('files/images/public-part/hnta_2026_home.svg') }}" alt="Arrow" class="hero-section__arrow hero-section__arrow_m">
...
{{--                    </a>--}}
    ...
    <div class="features" id="features">
        <div class="features__container">
            ...
            <div class="features__image">
                <img src="{{ asset('files/images/public-part/features-1-2025.svg') }}" alt="Features image">
            </div>
        </div>
    </div>
    <div class="features features--variant-one">
        <div class="features__container">
            ...
            <div class="features__image">
                <img src="{{ asset('files/images/public-part/features-2-2025.svg') }}" alt="Features image">
            </div>
        </div>
    </div>
        ...
        <div class="locations__slider_inner">
            ...
            <div class="homepage-locations__navigation">
                ...
                <a href="{{ route('public-part.locations.locations') }}" class="homepage-locations__navigation-all">
                    {{ __('Sve lokacije') }}
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                        <path d="M3.00006 13.6319L17.5861 13.6319L12.2931 18.9249L13.7071 20.3389L21.4141 12.6319L13.7071 4.92487L12.2931 6.33887L17.5861 11.6319L3.00006 11.6319V13.6319Z" fill="#66cccc"/>
                    </svg>
                </a>
            </div>
        </div>
