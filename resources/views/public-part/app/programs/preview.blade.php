                ...
                <div class="program__timeline-top">
                    ...
                    <div class="program__timeline-top-right">
                        <div class="program__timeline-top-right-day">
                            <div class="program__timeline-top-right-day-number active">
                                01
                            </div>
                            <div class="program__timeline-top-right-day-text active">pet</div>
                        </div>
                        <div class="program__timeline-top-right-day">
                            <div class="program__timeline-top-right-day-number active">
                                02
                            </div>
                            <div class="program__timeline-top-right-day-text active">sub</div>
                        </div>
                        <div class="program__timeline-top-right-day">
                            <div class="program__timeline-top-right-day-number active">
                                03
                            </div>
                            <div class="program__timeline-top-right-day-text active">ned</div>
                        </div>
                        <div class="program__timeline-top-right-day">
                            <div class="program__timeline-top-right-day-number">
                                04
                            </div>
                            <div class="program__timeline-top-right-day-text">pon</div>
                        </div>
                        <div class="program__timeline-top-right-day">
                            <div class="program__timeline-top-right-day-number">
                                05
                            </div>
                            <div class="program__timeline-top-right-day-text">uto</div>
                        </div>
                        <div class="program__timeline-top-right-day">
                            <div class="program__timeline-top-right-day-number">
                                06
                            </div>
                            <div class="program__timeline-top-right-day-text">sri</div>
                        </div>
                        <div class="program__timeline-top-right-day">
                            <div class="program__timeline-top-right-day-number">
                                07
                            </div>
                            <div class="program__timeline-top-right-day-text">čet</div>
                        </div>
                        <div class="program__timeline-top-right-day">
                            <div class="program__timeline-top-right-day-number">
                                08
                            </div>
                            <div class="program__timeline-top-right-day-text">pet</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="program__timeline-section sticky">
            <div class="program__timeline-container">
                <div class="program__timeline-header">
                    <h3 class="program__timeline-header-title">Dan 01</h3>
                    ...
                    @foreach($items as $item)
                        <div class="program__timeline-item">
                            <div class="program__timeline-item-left">
                                ...
                                <div class="program__timeline-item-left-tag">
                                    Predavanje
                                </div>
                                <div class="program__timeline-item-left-length">
                                    ...
                                    <div class="program__timeline-item-left-duration">170 min</div>
                                </div>
                            </div>
                            <div class="program__timeline-item-right">
                                <h2 class="program__timeline-item-right-title">Kompozicija elektronske muzike</h2>
                                ...
                                <p class="program__timeline-item-right-description">
