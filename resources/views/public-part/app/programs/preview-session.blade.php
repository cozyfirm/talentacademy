...
@section('public-content')
    ...
    <div class="preview-session__header preview-session__header_{{ CommonHelper::getBcgColor($program->id) }}">
...
{{--                    </svg>--}}
{{--                    <a href="{{ route('public-part.lecturers.single-lecturer', ['id' => $session->presenterRel->id ?? 0]) }}">--}}
...
{{--            @endif--}}
            @if($session->presentersRel->count())
                <div class="preview-session__title-item">
                    ...
                    <div class="ps-presenters-wrapper">
                        @php $total = 0; @endphp
                        @foreach($session->presentersRel as $presenter)
                            <a href="{{ route('public-part.lecturers.single-lecturer', ['id' => $presenter->presenter_id ?? 0]) }}">
            ...
            <div class="preview-session__title-item">
                ...
                <a href="{{ route('public-part.locations.single-location', ['id' => $session->locationRel->id ?? 0]) }}">
...
{{--                        <img src="{{ asset('files/images/public-part/arrow-2.svg') }}" alt="{{ __('New note') }}" class="news__list-item-image">--}}
    ...
    <div class="sessions__scroll_wrapper">
        <div class="sessions__scroll_iw">
            <div class="sessions__scroll_header">
                <h1>{{ __('Ostala predavanja') }}</h1>
            </div>

            <div class="sessions__scroll_body">
                @foreach($otherSessions as $otherSession)
                    <div class="sessions__scroll_single" uri="{{ route('public-part.programs.preview-session', ['id' => $otherSession->id]) }}">
                        ...
                        <div class="sss_www">
                            ...
                            <div class="scs_tw">
                                ...
                                {{ $otherSession->locationRel->title }}
                            </div>
                        </div>
                        <div class="description">
                            {{ $otherSession->short_description }}
                        </div>
                    </div>
                @endforeach
            </div>

            <div class="sessions__navigation">
                <div class="sessions__navigation-dots">
                ...
                <div class="sessions__navigation-buttons">
                    <button class="sessions__navigation-button pss_btn">
                    ...
                    <button class="sessions__navigation-button nss_btn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="34" height="16" viewBox="0 0 34 16" fill="none">
