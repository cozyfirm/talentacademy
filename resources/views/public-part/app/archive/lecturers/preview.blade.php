...
@section('meta_uri'){{ route('public-part.archive.lecturers.single-lecturer', ['id' => $lecturer->id]) }}@endsection
    ...
    <div class="programs__grid" id="programs__grid">
        ...
        <div class="programs__grid_pagination programs__grid_pagination_{{ $program->id }}">
            @for($i=1; $i<=$offlineSessions->lastPage(); $i++)
                ...
                <a href="{{ route('public-part.archive.lecturers.single-lecturer.page', ['id' => $lecturer->id, 'page' => $i]) }}#programs__grid_iw">
