...
@section('public-content')
    <div class="image__wrapper preview__image_wrapper d-none">
        ...
        <div class="img__wrapper_inside">
            <img class="main-image" id="gallery_main_img" src="">
        </div>

        <div class="arrows_wrapper">
            <button class="archive_gallery__navigation-button gallery__navigation_previous" attr-id="">
            ...
            <button class="archive_gallery__navigation-button gallery__navigation_next" attr-id="">
                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="16" viewBox="0 0 34 16" fill="none">
    ...
    <div class="archive__home__wrapper ">
        <div class="ahw__inner">
            ...
            <div class="gallery__load_more_w">
                <div class="load__more_gallery_btn">{{ __('Učitajte još fotografija') }}</div>
            </div>
        </div>
    </div>
