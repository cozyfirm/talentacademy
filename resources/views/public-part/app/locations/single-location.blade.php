                        ...
                        @foreach($similarLocations as $similarLocation)
                            <div class="single_location">
                                ...
                                <div class="text_wrapper">
                                    <h3> {{ $similarLocation->title }} </h3>
                                    <p>{{ $similarLocation->address }}, {{ $similarLocation->city }}</p>
                                </div>
                                <div class="btns_wrapper">
                                    <a href="{{ route('public-part.locations.single-location', ['id' => $similarLocation->id ]) }}">
                                        <div class="btn btn_bcg">
                                            {{ __('Više informacija') }}
                                        </div>
                                    </a>
                                    <a href="{{ $similarLocation->city }}" target="_blank">
                                        <div class="btn">
