            ...
            <div class="locations__list">
                @foreach($locations as $location)
                    <div class="locations__list-item">
                        <img src="{{ asset('files/images/public-part/locations-image-1.jpeg') }}" alt="Locations image" class="locations__list-image">
                        <h3 class="locations__list-item-title">Austrijska Kuća Sarajevo</h3>
                        <div class="locations__list-item-address">Zelenih beretki 2, Sarajevo</div>
                        ...
                        <img src="{{ asset('files/images/public-part/location-map.png') }}" class="locations__list-item-map @if($location === 1) locations__list-item-map--opened @endif">
