...
{{--                    <a href="#" class="footer__nav-link">Partneri</a>--}}
            ...
            <div class="footer__rest">
                ...
                <div class="footer__british-embassy">
                    <img src="{{ asset('files/images/public-part/british-embassy-logo.svg') }}" alt="British Embassy">
                    <p>DISCLAIMER:  ipsum dolor sit amet consectetur. Aliquam facilisi sed pellentesque vitae tortor bibendum dui in.</p>
                </div>
                <div class="footer__helem-nejse">
                    <h3>Helem Nejse Talent akademiju implementiraju:</h3>
