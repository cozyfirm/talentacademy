...
@section('c-breadcrumbs')
    <a href="#"> <i class="fas fa-home"></i> <p>{{ __('Dashboard') }}</p> </a> / <a href="{{ route('system.admin.pages') }}">{{ __('Single pages') }}</a>
@endsection
@section('c-buttons')
            ...
            @foreach($pages as $page)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{route('system.admin.pages.edit', ['id' => $page->id] )}}" title="{{ __('Više informacija') }}">
