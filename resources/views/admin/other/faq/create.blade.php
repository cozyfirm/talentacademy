...
@section('c-breadcrumbs')
    <a href="#"> <i class="fas fa-home"></i> <p>{{ __('Dashboard') }}</p> </a> / <a href="{{ route('system.admin.faq') }}">{{ __('FAQ') }}</a>
@endsection
@section('c-buttons')
    ...
    @if(isset($faq))
        <a href="{{ route('system.admin.faq.delete', ['id' => $faq->id ]) }}">
...
@section('content')
    <div class="content-wrapper content-wrapper-p-15">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="@if(isset($edit)) {{ route('system.admin.faq.update') }} @else {{ route('system.admin.faq.save') }} @endif" method="POST" id="js-form">
                    @if(isset($edit))
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {{ html()->textarea('description')->class('form-control form-control-sm mt-2 textarea-240')->value(isset($faq) ? $faq->description : '')->isReadonly(isset($preview)) }}
                            </div>
                        </div>
                    </div>
