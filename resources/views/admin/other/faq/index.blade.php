...
@section('c-buttons')
    ...
    <a href="{{ route('system.admin.faq.create') }}">
            ...
            @foreach($faqs as $faq)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{route('system.admin.faq.edit', ['id' => $faq->id] )}}" title="{{ __('Više informacija') }}">
                            <button class="btn-dark btn-xs">{{ __('Uredite') }}</button>
                        </a>
                    </td>
                </tr>
            @endforeach
