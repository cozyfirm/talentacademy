                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {{ html()->textarea('description')->class('form-control form-control-sm mt-2 textarea-240 summernote')->value(isset($program) ? $program->description : '')->isReadonly(isset($preview)) }}
                            </div>
                        </div>
                    </div>
